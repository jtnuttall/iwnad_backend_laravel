...
;define('iwnad/controllers/dashboard-page', ['exports'], function (exports) {
  ...
  exports.default = Ember.Controller.extend({
    ...
    init: function () {
      ...
      if (localStorage.currentDashboard !== undefined) {
        this.set('currentDashboard', JSON.parse(localStorage.currentDashboard)[0]);
        if (JSON.parse(localStorage.currentDashboard)[0].modules.length + 1 == JSON.parse(localStorage.currentDashboard)[0].currentphaseid) {
  ...
  exports.default = Ember.Controller.extend({
    ...
    actions: {
      ...
      signup() {
        ...
        //     profilepic: this.image,
        //   };
        data.append(this.role);
        data.append(this.organization);
        data.append(this.phone);
        data.append(this.password1);
        data.append(this.profilepic);
...
;
          if (!runningTests) {
            require("iwnad/app")["default"].create({"name":"iwnad","version":"0.0.0+21ce2312"});
          }
