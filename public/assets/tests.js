...
define('iwnad/tests/lint/app.lint-test', [], function () {
  ...
  QUnit.test('controllers/dashboard-page.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'controllers/dashboard-page.js should pass ESLint\n\n4:13 - \'service\' is defined but never used. (no-unused-vars)\n13:5 - \'$\' is not defined. (no-undef)\n19:7 - \'$\' is not defined. (no-undef)\n27:10 - \'error\' is defined but never used. (no-unused-vars)\n32:8 - \'$\' is not defined. (no-undef)\n42:11 - Unexpected console statement. (no-console)\n43:11 - Unexpected console statement. (no-console)');
  });
